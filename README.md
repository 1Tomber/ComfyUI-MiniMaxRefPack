...
- **The tags are on the tiles, and one click away from the prompt.** Every asset shows the label MiniMax will actually give it: `<Picture 2>`, `<Video 1>`, `<Audio 1>`. Double-click a tile to drop that tag into your direction text at the cursor, spaced correctly. What you see is what you address in the prompt.
